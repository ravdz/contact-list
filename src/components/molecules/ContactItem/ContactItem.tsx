...
export const ContactItem = memo(
  ({
    contact: { firstNameLastName, emailAddress, jobTitle, id },
    onSelect,
    isSelected,
  }: ContactItemProps) => {
    return (
      ...
      >
        <div className="contact-item__content">
          ...
          <div className="contact-item__info">
            <Heading className="contact-item__name">
              {firstNameLastName}
            </Heading>
            <Text as="span" className="contact-item__job-title">
              {jobTitle}
            </Text>
          </div>
        </div>
        <a
          ...
          className="contact-item__email-link"
        >
          {emailAddress}
        </a>
      </li>
